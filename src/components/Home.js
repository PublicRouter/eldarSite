    ...
    <div className='flex flex-col py-5'>
      ...
      <div className='text-xl text-white min-h-[100vh] sm:max-w-[75vw] sm:pl-8 sm:mx-auto mt-6 pt-[16vh]'  id="first-item">
        ...
        <ul className='mx-[4vw] mt-3 text-[1rem] p-8 lg:w-[65vw] font-titleSub rounded-lg backdrop-blur-sm bg-[rgb(58,17,12,.55)] opacity-80'>
            ...
            <li className='font-bold text-lg underline text-green-300 pb-2 italic'>Q3 2022:<em className='text-[rgb(206,158,26)]'></em></li>
            ...
            <li className='font-bold text-md text-green-300 pb-2 ml-2'><em className='text-gray-400'><em className='text-[1.5rem] mr-2 text-green-300'>✔</em>September 2022 - 4 Base Characters completed. Discord Community Engagement and Growth. Onboard moderators and any additional admin needed to continue oversight of social communications.  </em></li>
